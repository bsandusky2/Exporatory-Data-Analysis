...
plot(df$date,unfactor(df$Voltage), ylab = "Voltage", xlab = "DateTime",type = "l")
...
plot(df$date,unfactor(df$Global_reactive_power), ylab = "Global_reactive_power", xlab = "DateTime",type = "l")

png("Plot4.png") # default pixels are 480x480
dev.off()
